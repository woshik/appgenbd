        ...
        .then(result => {
            ...
            result.data.map((user, index) => {
                let button = !user.account_delete ? `
                        <a href="javascript:void(0)" title="Payment" class="mr-2" type="button" 
                        ...
                        <a href="javascript:void(0)" title="Account Status Change" class="mr-2" type="button" data-toggle="modal" 
